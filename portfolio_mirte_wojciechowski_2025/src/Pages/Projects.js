        ...
        <section id="ktm-project">
            <header className="header-projects header-ktm">
              ...
              <div className="project-section">
                <h1>KTM Project</h1>
                  <button className="header-button-projects"><a href="/evidence">Naar mijn bewijsmaterialen</a></button>
              </div>
        </section>
        ...
        <section id="roermond-project">
          <header className="header-projects header-roermond">
                <div className="header-right-projects">
                    ...
                    <p>
                    Tijdens deze opdracht heb ik voor de roermond outlet een advent kalender mogen maken. 
                    Met verschillende deals, en cadeautjes die je per dag kon openen. 
                    De focus lag hier vooral op het designen van een leuke en originele advent kalender, 
                    en het zorgen voor een leuke ervaring voor de gebruikers.
                    </p>
                </div>
            </header>
              <div className="project-section">
